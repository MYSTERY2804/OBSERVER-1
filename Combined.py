...
Be creative in extracting information based on context."""
    ...
    📅 Date: [Today's Date]
    🎯 Theme of the Day: [Identify 1-2 main themes from the conversation]
    🌱 Curiosity Seed Explored: [Identify any new interests mentioned]

    📊 Growth Metrics & Observations
    | Growth Area       | Rating (✅ Excellent/⚠ Fair/❌ Needs Work) | Observation Summary |
    |-------------------|------------------------------------------|----------------------|
    | 🧠 Intellectual   |                                          |                      |
    | 😊 Emotional      |                                          |                      |
    | 🤝 Social         |                                          |                      |
    ...
    🌈 Curiosity Response Index: [X]/10
    [Brief assessment of curiosity/engagement with new topics]

    🧠 Overall Growth Score:
    [🔵 Balanced Growth/🟡 Moderate Growth/🔴 Needs Encouragement] - [X]/7 Areas Active
    [Brief summary of development status]

    📣 Parent Note:
    [2-3 sentence personalized summary with specific suggestions]

    🟢 Legend:
    ✅ Excellent: Clear growth with evidence
    ⚠ Fair: Some engagement, needs encouragement
    ...
    INSTRUCTIONS:
    1. Extract concrete examples from the text for each growth area
    2. Ratings should be based on demonstrated evidence only
    3. Keep observations specific and actionable
    4. For areas with no information, use "❌ Needs Work" and note "No data"
    5. Maintain the exact emoji and formatting style shown
    6. Focus on growth mindset and development potential
    7. Also add legend part in every report
    """
